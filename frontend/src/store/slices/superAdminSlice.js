...
export const getMonthlyRevenue = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://3.134.52.198:5000/api/v1/superadmin/monthlyincome",
...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://3.134.52.198:5000/api/v1/superadmin/users/getall",
      { withCredentials: true }
    );
...
export const getAllPaymentProofs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://3.134.52.198:5000/api/v1/superadmin/paymentproofs/getall",
      { withCredentials: true }
    );
    dispatch(
...
export const deletePaymentProof = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `http://3.134.52.198:5000/api/v1/superadmin/paymentproof/delete/${id}`,
      { withCredentials: true }
    );
...
export const getSinglePaymentProofDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `http://3.134.52.198:5000/api/v1/superadmin/paymentproof/${id}`,
      { withCredentials: true }
    );
    dispatch(
...
export const updatePaymentProof = (id, status, amount) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `http://3.134.52.198:5000/api/v1/superadmin/paymentproof/status/update/${id}`,
      { status, amount },
...
export const deleteAuctionItem = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `http://3.134.52.198:5000/api/v1/superadmin/auctionitem/delete/${id}`,
      { withCredentials: true }
    );
