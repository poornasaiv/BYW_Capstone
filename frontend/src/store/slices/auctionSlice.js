...
export const getAllAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://3.134.52.198:5000/api/v1/auctionitem/allitems",
...
export const getMyAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "http://3.134.52.198:5000/api/v1/auctionitem/myitems",
      { withCredentials: true }
    );
...
export const getAuctionDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `http://3.134.52.198:5000/api/v1/auctionitem/auction/${id}`,
      { withCredentials: true }
    );
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "http://3.134.52.198:5000/api/v1/auctionitem/create",
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `http://3.134.52.198:5000/api/v1/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `http://3.134.52.198:5000/api/v1/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
